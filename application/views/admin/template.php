                ...
                <div class="navbar">
                  <div class="navbar-inner">
                    ...
                    <ul class="nav">
                      ...
                      <li class="<?php echo $s1 ?>"><a href="<?php echo URL::site('/admin_admin'); ?>">Home</a></li>
                      <li class="divider-vertical"></li>
                      <li class="<?php echo $s2 ?>"><a href="<?php echo URL::site('/admin_equipment'); ?>">Equipment</a></li>
                      <li class="divider-vertical"></li>
                      <li class="<?php echo $s3 ?>"><a href="<?php echo URL::site('/admin_currentrentals'); ?>">Current Rentals</a></li>
                      <li class="divider-vertical"></li>
                      <li class="<?php echo $s4 ?>"><a href="<?php echo URL::site('/admin_pastrentals'); ?>">Past Rentals</a></li>
                    </ul>
